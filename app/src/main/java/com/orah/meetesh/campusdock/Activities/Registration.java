...
import static com.orah.meetesh.campusdock.Utils.Config.PREF_NAME;
...
public class Registration extends AppCompatActivity {
    ...
    private boolean validate(String roll){
        ...
        if(!isNetworkAvailable()){
            Toasty.error(getApplicationContext(), "No Network").show();
            return false;
        }
        else return true;
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            editor.putString(PREF_USER_SUBSCRIPTIONS, "4csb");
    ...
    private void subscribe(JSONObject obj) throws JSONException{
        ...
        FirebaseMessaging.getInstance().subscribeToTopic(pref.getString(PREF_USER_ROLL, "global").replace('/','-'));// slashes are not allowed in topic
    }
